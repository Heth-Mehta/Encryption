...
firebase=firebase.FirebaseApplication("https://encryption-chatting-app-default-rtdb.firebaseio.com/",None)
login_window = Tk()
login_window.geometry("400x400")
login_window.config(bg='cyan')
...
username_label = Label(login_window, text="Username : " , font = 'arial 13', bg ='yellow', fg="red")
username_label.place(relx=0.3,rely=0.3, anchor=CENTER)

username_entry = Entry(login_window)
username_entry.place(relx=0.6,rely=0.3, anchor=CENTER)

your_code_label = Label(login_window, text="Your code :  " , font = 'arial 13', bg ='yellow', fg="red")
...
friends_code_label = Label(login_window, text="Your Friends code :  " , font = 'arial 13', bg ='yellow', fg="red")
...
btn_start = Button(login_window, text="Start" , font = 'arial 13' , bg="lightgreen", fg="black", command=enterRoom, relief=FLAT, padx=10)
